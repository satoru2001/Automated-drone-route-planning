...
#Creating a polygon for illustration purposes(it will be replaced by shape of given area)
polygon = [(-5,0), ( -4,3),(-1,1), (0,-5), (-4,-3),(-5,0)]

#Creating a mesh grid on top of that and  the distance between each points in meshgrid depends on the area an camera can cover with out losing clarity.
#(i.e length of side of largest square of picture by drone's camera) here we took 1-unit 
